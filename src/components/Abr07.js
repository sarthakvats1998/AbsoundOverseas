  ...
  return (
    <div>
        ...
        <div className="carousel-container d-flex justify-content-center">
            <img src={abr07} style={{width: 350, height: 400}} alt="Slide 1" />
        </div>
                        ...
                        <Card className="custom-card">
                            <Card.Body>
                                <Card.Text>
                                    ...
                                    <div className="spec-content">540 mm</div>
                                </Card.Text>
                                <Card.Text>
                                    <div className="spec-title">Seat Depth</div>
                                    <div className="spec-content">500 mm</div>
                                </Card.Text>
                                <Card.Text>
                                ...
                                <Card.Text>
                                    ...
                                    <div className="spec-content">42 Kg</div>
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
                        ...
                        <Card className="custom-card">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    <div className="spec-content">1130 mm</div>
                                </Card.Text>
                                <Card.Text>
                                    <div className="spec-title">Backrest Thickness</div>
                                    <div className="spec-content">225 mm</div>
                                </Card.Text>
                                <Card.Text>
                        ...
                        <Card className="custom-card">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    <div className="spec-content">840 mm</div>
                                </Card.Text>
                                <Card.Text>
                                    <div className="spec-title">Center to Center Width</div>
                                    <div className="spec-content">690 mm</div>
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
