  ...
  return (
    <div>
        ...
        <div className="carousel-container d-flex justify-content-center">
            <img src={fresnel} style={{width: 420, height: 380}} alt="Slide 1" />
        </div>
                        ...
                        <Card className="custom-card" style={{width:'auto', textAlign:'center'}}>
                            <Card.Body>
                                <Card.Text>
                                    ...
                                    <div className="spec-content">60W / 100W / 200W / 300W / 400W</div>
                                </Card.Text>
                                <br/>
                                <Card.Text>
