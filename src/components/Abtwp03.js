  ...
  return (
    <div>
        ...
        <div className="carousel-container d-flex justify-content-center">
            <img src={abtwp03} style={{width: 350, height: 400}} alt="Slide 1" />
        </div>
        ...
        <div className='container'>
            ...
            <div className='bullet'>
                <ul>
                    <li>The chair comes with auto tip-up seats with writing pad.</li><br/>
                        ...
                        <Card className="custom-card">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    <div className="spec-content">490 mm</div>
                                </Card.Text>
                                <Card.Text>
