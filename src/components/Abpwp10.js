  ...
  return (
    <div>
        ...
        <div className="carousel-container d-flex justify-content-center">
            <img src={abpwp10} style={{width: 350, height: 400}} alt="Slide 1" />
        </div>
        ...
        <div className='container'>
            ...
            <div className='bullet'>
                <ul>
                    <li>The chair comes with sliding seats with writing pad.</li><br/>
                        ...
                        <Card className="custom-card">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    <div className="spec-content">650 mm</div>
                                </Card.Text>
                                <Card.Text>
                                    <div className="spec-title">Center to Center Width</div>
                                    <div className="spec-content">575 mm</div>
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
