  ...
  return (
    <div>
        ...
        <div className="carousel-container d-flex justify-content-center">
            <img src={abt01} style={{width: 350, height: 400}} alt="Slide 1" />
        </div>
                        ...
                        <Card className="custom-card">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    <div className="spec-content">460 mm</div>
                                </Card.Text>
                                <Card.Text>
                        ...
                        <Card className="custom-card">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    <div className="spec-content">1050 mm</div>
                                </Card.Text>
                                <Card.Text>
                        ...
                        <Card className="custom-card">
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    <div className="spec-content">600 mm</div>
                                </Card.Text>
                                <Card.Text>
                                    <div className="spec-title">Center to Center Width</div>
                                    <div className="spec-content">525 mm</div>
                                </Card.Text>
                            </Card.Body>
                        </Card>
                    </Col>
